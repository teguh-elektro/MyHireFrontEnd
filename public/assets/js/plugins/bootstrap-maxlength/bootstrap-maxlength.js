    ...
    maxlength: function (options, callback) {
      ...
      */
      ...
      function place (currentInput, maxLengthIndicator) {
        ...
        var outerWidth = maxLengthIndicator.outerWidth()
        var actualWidth = maxLengthIndicator.width()
        var actualHeight = maxLengthIndicator.height()
      ...
      return this.each(function () {
        ...
        currentInput.on('input', function () {
          ...
          var remaining = remainingChars(currentInput, maxlength)
          var output = true
