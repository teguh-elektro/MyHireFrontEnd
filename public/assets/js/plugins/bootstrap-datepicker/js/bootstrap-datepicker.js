...
(function (factory) {
  ...
  Datepicker.prototype = {
    ...
    fill: function () {
      ...
      var todayDate = UTCToday()
      var titleBtnVisible = (this.o.todayBtn === true || this.o.todayBtn === 'linked') && todayDate >= this.o.startDate && todayDate <= this.o.endDate && !this.weekOfDateIsDisabled(todayDate)
      var tooltip
      var before
