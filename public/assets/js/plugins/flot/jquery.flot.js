...
(function ($) {
  ...
  function Plot (placeholder, data_, options_, plugins) {
    ...
    var surface = null // the canvas for the plot itself
    var overlay = null // canvas for interactive stuff on top of plot
    var eventHolder = null // jQuery object that events should be bound to
    var ctx = null; var octx = null
    var xaxes = []; var yaxes = []
    var plotOffset = { left: 0, right: 0, top: 0, bottom: 0 }
    var plotWidth = 0; var plotHeight = 0
    var hooks = {
      processOptions: [],
      processRawData: [],
      processDatapoints: [],
    ...
    function parseOptions (opts) {
      ...
      var i; var axisOptions; var axisCount
    ...
    function axisToCanvasCoords (pos) {
      ...
      var res = {}; var i; var axis; var key
    ...
    function fillInSeriesOptions () {
      var neededColors = series.length; var maxIndex = -1; var i
      ...
      var c; var colors = []; var colorPool = options.colors
      var colorPoolSize = colorPool.length; var variation = 0
    ...
    function processData () {
      ...
      var i; var j; var k; var m; var length
      var s; var points; var ps; var x; var y; var axis; var val; var f; var p
      var data; var format
      ...
      for (i = 0; i < series.length; ++i) {
        ...
        var xmin = topSentry; var ymin = topSentry
        var xmax = bottomSentry; var ymax = bottomSentry
    ...
    function setTransformationHelpers (axis) {
      ...
      var s; var m; var t = axis.options.transform || identity
    ...
    function measureTickLabels (axis) {
      ...
      var maxWidth = labelWidth || (axis.direction == 'x' ? Math.floor(surface.width / (ticks.length || 1)) : null)
    ...
    function setupGrid () {
      var i; var axes = allAxes(); var showGrid = options.grid.show
    ...
    function setTicks (axis) {
      var oticks = axis.options.ticks; var ticks = []
    ...
    function extractRange (ranges, coord) {
      var axis; var from; var to; var key; var axes = allAxes()
    ...
    function drawGrid () {
      ...
      for (var j = 0; j < axes.length; ++j) {
        var axis = axes[j]; var box = axis.box
        var t = axis.tickLength; var x; var y; var xoff; var yoff
    ...
    function drawAxisLabels () {
      $.each(allAxes(), function (_, axis) {
        ...
        var tick; var x; var y; var halign; var valign
    ...
    function drawSeriesLines (series) {
      function plotLine (datapoints, xoffset, yoffset, axisx, axisy) {
        ...
        for (var i = ps; i < points.length; i += ps) {
          var x1 = points[i - ps]; var y1 = points[i - ps + 1]
          var x2 = points[i]; var y2 = points[i + 1]
      ...
      function plotLineArea (datapoints, axisx, axisy) {
        ...
        var i = 0; var top; var areaOpen = false
        var ypos = 1; var segmentStart = 0; var segmentEnd = 0
        ...
        while (true) {
          ...
          var x2 = points[i]; var y2 = points[i + ypos]
    ...
    function drawSeriesPoints (series) {
      function plotPoints (datapoints, radius, fillStyle, offset, shadow, axisx, axisy, symbol) {
        var points = datapoints.points; var ps = datapoints.pointsize

        for (var i = 0; i < points.length; i += ps) {
          var x = points[i]; var y = points[i + 1]
    ...
    function insertLegend () {
      ...
      var fragments = []; var entries = []; var rowStarted = false
      var lf = options.legend.labelFormatter; var s; var label
    ...
    function findNearbyItem (mouseX, mouseY, seriesFilter) {
      ...
      var item = null; var foundPoint = false; var i; var j; var ps
      ...
      for (i = series.length - 1; i >= 0; --i) {
        ...
        var mx = axisx.c2p(mouseX) // precompute some stuff to make the loop faster
        ...
        if (s.lines.show || s.points.show) {
          for (j = 0; j < points.length; j += ps) {
            var x = points[j]; var y = points[j + 1]
            if (x == null) { continue }
        ...
        if (s.bars.show && !item) { // no other point can be nearby
          ...
          for (j = 0; j < points.length; j += ps) {
            var x = points[j]; var y = points[j + 1]; var b = points[j + 2]
            if (x == null) { continue }
    ...
    function drawPointHighlight (series, point) {
      ...
      var axisx = series.xaxis; var axisy = series.yaxis
