...
(function ($) {
  ...
  var methods = {
    ...
    _createCancel: function () {
      ...
      var cancel = $('<' + this.opt.starType + ' />', { title: this.opt.cancelHint, class: this.opt.cancelClass })
    ...
    _createStars: function () {
      for (var i = 1; i <= this.opt.number; i++) {
        ...
        var attrs = { alt: i, src: this.opt.path + this.opt[name] }
    ...
    _fill: function (score) {
      ...
      for (var i = 1; i <= this.stars.length; i++) {
        ...
        var turnOn = methods._turnOn.call(this, i, score)
