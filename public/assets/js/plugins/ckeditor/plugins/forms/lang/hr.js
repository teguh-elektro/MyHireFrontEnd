CKEDITOR.plugins.setLang('forms', 'hr', {
  button: { title: 'Svojstva gumba', text: 'Tekst (vrijednost)', type: 'Vrsta', typeBtn: 'Gumb', typeSbm: 'Pošalji', typeRst: 'Poništi' },
  checkboxAndRadio: { checkboxTitle: 'Checkbox svojstva', radioTitle: 'Radio Button svojstva', value: 'Vrijednost', selected: 'Odabrano', required: 'Potrebno' },
