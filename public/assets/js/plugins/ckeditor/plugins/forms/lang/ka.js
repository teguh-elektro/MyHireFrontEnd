CKEDITOR.plugins.setLang('forms', 'ka', {
  ...
  checkboxAndRadio: { checkboxTitle: 'მონიშვნის ღილაკის (Checkbox) პარამეტრები', radioTitle: 'ასარჩევი ღილაკის (Radio) პარამეტრები', value: 'ტექსტი', selected: 'არჩეული', required: 'Required' },
