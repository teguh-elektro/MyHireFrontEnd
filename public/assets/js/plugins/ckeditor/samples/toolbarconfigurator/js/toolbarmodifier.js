(function () {
  ...
  ToolbarConfigurator.ToolbarModifier = d; d.prototype = Object.create(ToolbarConfigurator.AbstractToolbarModifier.prototype); d.prototype.getActualConfig = function () { var a = l.prototype.getActualConfig.call(this); if (a.toolbarGroups) for (var b = a.toolbarGroups.length, c = 0; c < b; c += 1)a.toolbarGroups[c] = d.parseGroupToConfigValue(a.toolbarGroups[c]); return a }; d.prototype._onInit = function (a, b, c) {
    ...
    var a = this.getActualConfig(); var b; var c; if (a.toolbarGroups) {
...
(this._createToolbar(), this.toolbarContainer.insertBefore(this.mainContainer.getChildren().getItem(0))); this.showToolbarBtnsByGroupName('edit'); this.configContainer || (this.configContainer = new CKEDITOR.dom.element('div'), this.configContainer.addClass('configContainer'), this.configContainer.addClass('hidden'), this.mainContainer.append(this.configContainer)); return this.mainContainer
    ...
    a = new CKEDITOR.dom.element(a); var b = a.getAscendant('li'); var c = b.getAscendant('ul'); var e = b.data('type'); var d = b.data('name'); var g = a.data('direction'); var m = g === 'up' ? b.getPrevious() : b.getNext(); var h; if (a.hasClass('disabled')) return null
...
'[data-direction\x3d"' + (g === 'up' ? 'down' : 'up') + '"]', this.cachedActiveElement = a.getParent().findOne(k)); this._refreshMoveBtnsAvalibility(); this._refreshBtnTabIndexes(); return { action: 'move' }
  ...
  }; d.prototype._refreshBtnTabIndexes = function () { for (var a = this.mainContainer.find('[data-tab\x3d"true"]'), b = a.count(), c = 0; c < b; c++) { var e = a.getItem(c); var d = e.hasClass('disabled'); e.setAttribute('tabindex', d ? -1 : c) } }; d.prototype._disableElementsInList = function (a) {
    ...
    var a = this._determineSeparatorToAddIndex(); var b = d.createSeparatorLiteral()
...
function () { for (var a = this.actualConfig.toolbarGroups, b = a.length; b--;) { var c = a[b]; var e = d.getTotalGroupButtonsNumber(c, this.fullToolbarEditor); c.type != 'separator' && (c.totalBtns = e) } }; d.prototype._addButtonToRemoved = function (a) { if (CKEDITOR.tools.indexOf(this.removedButtons, a) != -1) throw 'Button already added to removed'; this.removedButtons.push(a); this.actualConfig.removeButtons = this.removedButtons.join(','); this._refreshEditor() }; d.prototype._removeButtonFromRemoved = function (a) {
  ...
  }; d.parseGroupToConfigValue = function (a) { if (a.type == 'separator') return '/'; var b = a.groups; var c = b.length; delete a.totalBtns; for (var d = 0; d < c; d += 1)b[d] = b[d].name; return a }; d.getGroupOrSeparatorLiAncestor = function (a) {
    return a.$ instanceof HTMLLIElement && a.data('type') == 'group' ? a : d.getFirstAncestor(a, function (a) {
      a = a.data('type')
      return a == 'group' || a == 'separator'
    })
  }; d.createSeparatorLiteral = function () { return { type: 'separator', name: 'separator' + CKEDITOR.tools.getNextNumber() } }; d.prototype._toolbarConfigToListString = function () { for (var a = this.actualConfig.toolbarGroups || [], b = '\x3cul data-type\x3d"table-body"\x3e', c = a.length, e = 0; e < c; e += 1) var f = a[e]; var b = f.type === 'separator' ? b + d.getToolbarSeparatorString(f) : b + this._getToolbarGroupString(f); b += '\x3c/ul\x3e'; return d.getToolbarHeaderString() + b }; d.prototype._getToolbarGroupString = function (a) {
    var b =
a.groups; var c; c = '' + ['\x3cli data-type\x3d"group" data-name\x3d"', a.name, '" ', a.totalBtns ? '' : 'class\x3d"empty"', '\x3e'].join(''); c += d.getToolbarElementPreString(a) + '\x3cul\x3e'; a = b.length; for (var e = 0; e < a; e += 1) { var f = b[e]; c += this._getToolbarSubgroupString(f, this.fullToolbarEditor.buttonsByGroup[f.name]) } return c + '\x3c/ul\x3e\x3c/li\x3e'
