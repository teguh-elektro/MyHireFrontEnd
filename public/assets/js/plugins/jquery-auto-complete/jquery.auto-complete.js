  ...
  $.fn.autoComplete = function (options) {
    ...
    return this.each(function () {
        ...
        if (!resize) {
          ...
          if (that.sc.suggestionHeight) {
            if (!next) that.sc.scrollTop(0)
              ...
              var scrTop = that.sc.scrollTop(); var selTop = next.offset().top - that.sc.offset().top
      ...
      that.sc.on('mousedown', '.autocomplete-suggestion', function (e) {
        var item = $(this); var v = item.data('val')
      ...
      that.on('keydown.autocomplete', function (e) {
        ...
        if ((e.which == 40 || e.which == 38) && that.sc.html()) {
          var next; var sel = $('.autocomplete-suggestion.selected', that.sc)
          if (!sel.length) {
