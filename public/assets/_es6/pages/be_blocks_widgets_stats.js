...
class BeBlocksWidgetsStats {
  ...
  static initWidgetsChartJS () {
    ...
    // Chart Containers
    const chartWidgetLinesCon = jQuery('.js-chartjs-widget-lines')
    const chartWidgetLinesCon2 = jQuery('.js-chartjs-widget-lines2')
    const chartWidgetLinesCon3 = jQuery('.js-chartjs-widget-lines3')
    const chartWidgetLinesCon4 = jQuery('.js-chartjs-widget-lines4')

    // Charts letiables
    let chartWidgetLines, chartWidgetLines2, chartWidgetLines3, chartWidgetLines4

    // Lines Charts Data
    const chartWidgetLinesData = {
