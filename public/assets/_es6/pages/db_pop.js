...
class DbPop {
  ...
  static initPopChartJS () {
    ...
    // Chart Containers
    const chartPopLinesCon = jQuery('.js-chartjs-pop-lines')
    const chartPopLinesCon2 = jQuery('.js-chartjs-pop-lines2')

    // Chart Variables
    let chartPopLines, chartPopLines2

    // Lines Charts Data
    const chartPopLinesData = {
