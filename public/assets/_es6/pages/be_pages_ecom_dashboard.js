...
class BePagesEcomDashboard {
  ...
  static initEcomChartJS () {
    ...
    // Chart Containers
    const chartEcomEarningsCon = jQuery('.js-chartjs-ecom-dashboard-earnings')
    const chartEcomOrdersCon = jQuery('.js-chartjs-ecom-dashboard-orders')

    // Charts Variables
    let chartEcomOrders, chartEcomEarnings

    // Charts Data
    const chartEcomEarningsData = {
