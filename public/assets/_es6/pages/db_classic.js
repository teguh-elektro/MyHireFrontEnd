...
class DbClassic {
  ...
  static initClassicChartJS () {
    ...
    // Chart Containers
    const chartClassicLinesCon = jQuery('.js-chartjs-classic-lines')
    const chartClassicLinesCon2 = jQuery('.js-chartjs-classic-lines2')

    // Chart Variables
    let chartClassicLines, chartClassicLines2

    // Lines Charts Data
    const chartClassicLinesData = {
    ...
    const chartClassicLinesOptions = {
      scales: {
        yAxes: [{
          ticks: {
            suggestedMax: 50
    ...
    const chartClassicLinesOptions2 = {
      scales: {
        yAxes: [{
          ticks: {
            suggestedMax: 480
