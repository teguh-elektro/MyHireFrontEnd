...
class DbMinimal {
  ...
  static initMinimalChartJS () {
    ...
    // Chart Containers
    const chartMinimalLinesCon = jQuery('.js-chartjs-minimal-lines')
    const chartMinimalLinesCon2 = jQuery('.js-chartjs-minimal-lines2')

    // Chart Variables
    let chartMinimalLines, chartMinimalLines2

    // Lines Charts Data
    const chartMinimalLinesData = {
    ...
    const chartMinimalLinesOptions = {
      scales: {
        yAxes: [{
          ticks: {
            suggestedMax: 50
    ...
    const chartMinimalLinesOptions2 = {
      scales: {
        yAxes: [{
          ticks: {
            suggestedMax: 480
