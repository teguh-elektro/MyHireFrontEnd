...
class DbCorporate {
  ...
  static initCorporateChartJS () {
    ...
    // Chart Containers
    const chartCorporateLinesCon = jQuery('.js-chartjs-corporate-lines')
    const chartCorporateLinesCon2 = jQuery('.js-chartjs-corporate-lines2')

    // Chart Variables
    let chartCorporateLines, chartCorporateLines2

    // Lines Charts Data
    const chartCorporateLinesData = {
    ...
    const chartCorporateLinesOptions = {
      scales: {
        yAxes: [{
          ticks: {
            suggestedMax: 50
    ...
    const chartCorporateLinesData2 = {
      labels: ['MON', 'TUE', 'WED', 'THU', 'FRI', 'SAT', 'SUN'],
      datasets: [
        {
          label: 'This Week',
    ...
    const chartCorporateLinesOptions2 = {
      scales: {
        yAxes: [{
          ticks: {
            suggestedMax: 480
