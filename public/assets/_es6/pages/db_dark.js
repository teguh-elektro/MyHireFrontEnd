...
class DbDark {
  ...
  static initDarkChartJS () {
    ...
    // Chart Containers
    const chartDarkLinesCon = jQuery('.js-chartjs-dark-lines')
    const chartDarkLinesCon2 = jQuery('.js-chartjs-dark-lines2')

    // Chart Variables
    let chartDarkLines, chartDarkLines2

    // Lines Charts Data
    const chartDarkLinesData = {
